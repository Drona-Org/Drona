...
_time_boot_ms : int,  /*Timestamp (milliseconds since system boot)*/
_focal_length : float32,  /*Focal length in mm*/
_sensor_size_h : float32,  /*Image sensor size horizontal in mm*/
_sensor_size_v : float32,  /*Image sensor size vertical in mm*/
...
_time_boot_ms : int,  /*Timestamp (milliseconds since system boot)*/
_aperture : float32,  /*Aperture is 1/value*/
_shutter_speed : float32,  /*Shutter speed in s*/
_iso_sensitivity : float32,  /*ISO sensitivity*/
_white_balance : float32,  /*Color temperature in K*/
_camera_id : int,  /*Camera ID if there are multiple*/
...
_time_boot_ms : int,  /*Timestamp (milliseconds since system boot)*/
_total_capacity : float32,  /*Total capacity in MiB*/
_used_capacity : float32,  /*Used capacity in MiB*/
_available_capacity : float32,  /*Available capacity in MiB*/
_read_speed : float32,  /*Read speed in MiB/s*/
_write_speed : float32,  /*Write speed in MiB/s*/
...
_time_boot_ms : int,  /*Timestamp (milliseconds since system boot)*/
_image_interval : float32,  /*Image capture interval in seconds*/
_video_framerate : float32,  /*Video frame rate in Hz*/
...
_q : seq[float32],  /*Quaternion of camera orientation (w, x, y, z order, zero-rotation is 0, 0, 0, 0)*/
_camera_id : int,  /*Camera ID if there are multiple*/
...
_time_boot_ms : int,  /*Timestamp (milliseconds since system boot)*/
_roll : float32,  /*Roll in degrees*/
_pitch : float32,  /*Pitch in degrees*/
_yaw : float32  /*Yaw in degrees*/

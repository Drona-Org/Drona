  ...
  #ifndef P_PMAVLINKMESSAGES_H_
    #define P_PMAVLINKMESSAGES_H_
    #include "PrtUser.h"
    ...
    enum P_FIELD_INDEX_mavlink_button_change_t
    {
      P_FIELD_INDEX_mavlink_button_change_t__time_boot_ms = 0,
      P_FIELD_INDEX_mavlink_button_change_t__last_change_ms = 1,
      P_FIELD_INDEX_mavlink_button_change_t__state = 2,
      _P_FIELD_INDEX_mavlink_button_change_t_COUNT = 3
    };

    enum P_FIELD_INDEX_mavlink_camera_capture_status_t
    {
      P_FIELD_INDEX_mavlink_camera_capture_status_t__time_boot_ms = 0,
      P_FIELD_INDEX_mavlink_camera_capture_status_t__image_interval = 1,
      P_FIELD_INDEX_mavlink_camera_capture_status_t__video_framerate = 2,
      P_FIELD_INDEX_mavlink_camera_capture_status_t__image_resolution_h = 3,
      P_FIELD_INDEX_mavlink_camera_capture_status_t__image_resolution_v = 4,
      P_FIELD_INDEX_mavlink_camera_capture_status_t__video_resolution_h = 5,
      P_FIELD_INDEX_mavlink_camera_capture_status_t__video_resolution_v = 6,
      P_FIELD_INDEX_mavlink_camera_capture_status_t__camera_id = 7,
      P_FIELD_INDEX_mavlink_camera_capture_status_t__image_status = 8,
      P_FIELD_INDEX_mavlink_camera_capture_status_t__video_status = 9,
      _P_FIELD_INDEX_mavlink_camera_capture_status_t_COUNT = 10
    };

    enum P_FIELD_INDEX_mavlink_camera_image_captured_t
    {
      P_FIELD_INDEX_mavlink_camera_image_captured_t__time_utc = 0,
      P_FIELD_INDEX_mavlink_camera_image_captured_t__time_boot_ms = 1,
      P_FIELD_INDEX_mavlink_camera_image_captured_t__lat = 2,
      P_FIELD_INDEX_mavlink_camera_image_captured_t__lon = 3,
      P_FIELD_INDEX_mavlink_camera_image_captured_t__alt = 4,
      P_FIELD_INDEX_mavlink_camera_image_captured_t__relative_alt = 5,
      P_FIELD_INDEX_mavlink_camera_image_captured_t__q = 6,
      P_FIELD_INDEX_mavlink_camera_image_captured_t__camera_id = 7,
      P_FIELD_INDEX_mavlink_camera_image_captured_t__file_path = 8,
      _P_FIELD_INDEX_mavlink_camera_image_captured_t_COUNT = 9
    };

    enum P_FIELD_INDEX_mavlink_camera_information_t
    {
      P_FIELD_INDEX_mavlink_camera_information_t__time_boot_ms = 0,
      P_FIELD_INDEX_mavlink_camera_information_t__focal_length = 1,
      P_FIELD_INDEX_mavlink_camera_information_t__sensor_size_h = 2,
      P_FIELD_INDEX_mavlink_camera_information_t__sensor_size_v = 3,
      P_FIELD_INDEX_mavlink_camera_information_t__resolution_h = 4,
      P_FIELD_INDEX_mavlink_camera_information_t__resolution_v = 5,
      P_FIELD_INDEX_mavlink_camera_information_t__camera_id = 6,
      P_FIELD_INDEX_mavlink_camera_information_t__vendor_name = 7,
      P_FIELD_INDEX_mavlink_camera_information_t__model_name = 8,
      P_FIELD_INDEX_mavlink_camera_information_t__lense_id = 9,
      _P_FIELD_INDEX_mavlink_camera_information_t_COUNT = 10
    };

    enum P_FIELD_INDEX_mavlink_camera_settings_t
    {
      P_FIELD_INDEX_mavlink_camera_settings_t__time_boot_ms = 0,
      P_FIELD_INDEX_mavlink_camera_settings_t__aperture = 1,
      P_FIELD_INDEX_mavlink_camera_settings_t__shutter_speed = 2,
      P_FIELD_INDEX_mavlink_camera_settings_t__iso_sensitivity = 3,
      P_FIELD_INDEX_mavlink_camera_settings_t__white_balance = 4,
      P_FIELD_INDEX_mavlink_camera_settings_t__camera_id = 5,
      P_FIELD_INDEX_mavlink_camera_settings_t__aperture_locked = 6,
      P_FIELD_INDEX_mavlink_camera_settings_t__shutter_speed_locked = 7,
      P_FIELD_INDEX_mavlink_camera_settings_t__iso_sensitivity_locked = 8,
      P_FIELD_INDEX_mavlink_camera_settings_t__white_balance_locked = 9,
      P_FIELD_INDEX_mavlink_camera_settings_t__mode_id = 10,
      P_FIELD_INDEX_mavlink_camera_settings_t__color_mode_id = 11,
      P_FIELD_INDEX_mavlink_camera_settings_t__image_format_id = 12,
      _P_FIELD_INDEX_mavlink_camera_settings_t_COUNT = 13
    };
    ...
    enum P_FIELD_INDEX_mavlink_flight_information_t
    {
      P_FIELD_INDEX_mavlink_flight_information_t__arming_time_utc = 0,
      P_FIELD_INDEX_mavlink_flight_information_t__takeoff_time_utc = 1,
      P_FIELD_INDEX_mavlink_flight_information_t__flight_uuid = 2,
      P_FIELD_INDEX_mavlink_flight_information_t__time_boot_ms = 3,
      _P_FIELD_INDEX_mavlink_flight_information_t_COUNT = 4
    };
    ...
    enum P_FIELD_INDEX_mavlink_logging_ack_t
    {
      P_FIELD_INDEX_mavlink_logging_ack_t__sequence = 0,
      P_FIELD_INDEX_mavlink_logging_ack_t__target_system = 1,
      P_FIELD_INDEX_mavlink_logging_ack_t__target_component = 2,
      _P_FIELD_INDEX_mavlink_logging_ack_t_COUNT = 3
    };

    enum P_FIELD_INDEX_mavlink_logging_data_acked_t
    {
      P_FIELD_INDEX_mavlink_logging_data_acked_t__sequence = 0,
      P_FIELD_INDEX_mavlink_logging_data_acked_t__target_system = 1,
      P_FIELD_INDEX_mavlink_logging_data_acked_t__target_component = 2,
      P_FIELD_INDEX_mavlink_logging_data_acked_t__length = 3,
      P_FIELD_INDEX_mavlink_logging_data_acked_t__first_message_offset = 4,
      P_FIELD_INDEX_mavlink_logging_data_acked_t__data = 5,
      _P_FIELD_INDEX_mavlink_logging_data_acked_t_COUNT = 6
    };

    enum P_FIELD_INDEX_mavlink_logging_data_t
    {
      P_FIELD_INDEX_mavlink_logging_data_t__sequence = 0,
      P_FIELD_INDEX_mavlink_logging_data_t__target_system = 1,
      P_FIELD_INDEX_mavlink_logging_data_t__target_component = 2,
      P_FIELD_INDEX_mavlink_logging_data_t__length = 3,
      P_FIELD_INDEX_mavlink_logging_data_t__first_message_offset = 4,
      P_FIELD_INDEX_mavlink_logging_data_t__data = 5,
      _P_FIELD_INDEX_mavlink_logging_data_t_COUNT = 6
    };
    ...
    enum P_FIELD_INDEX_mavlink_mount_orientation_t
    {
      P_FIELD_INDEX_mavlink_mount_orientation_t__time_boot_ms = 0,
      P_FIELD_INDEX_mavlink_mount_orientation_t__roll = 1,
      P_FIELD_INDEX_mavlink_mount_orientation_t__pitch = 2,
      P_FIELD_INDEX_mavlink_mount_orientation_t__yaw = 3,
      _P_FIELD_INDEX_mavlink_mount_orientation_t_COUNT = 4
    };
    ...
    enum P_FIELD_INDEX_mavlink_play_tune_t
    {
      P_FIELD_INDEX_mavlink_play_tune_t__target_system = 0,
      P_FIELD_INDEX_mavlink_play_tune_t__target_component = 1,
      P_FIELD_INDEX_mavlink_play_tune_t__tune = 2,
      _P_FIELD_INDEX_mavlink_play_tune_t_COUNT = 3
    };
    ...
    enum P_FIELD_INDEX_mavlink_storage_information_t
    {
      P_FIELD_INDEX_mavlink_storage_information_t__time_boot_ms = 0,
      P_FIELD_INDEX_mavlink_storage_information_t__total_capacity = 1,
      P_FIELD_INDEX_mavlink_storage_information_t__used_capacity = 2,
      P_FIELD_INDEX_mavlink_storage_information_t__available_capacity = 3,
      P_FIELD_INDEX_mavlink_storage_information_t__read_speed = 4,
      P_FIELD_INDEX_mavlink_storage_information_t__write_speed = 5,
      P_FIELD_INDEX_mavlink_storage_information_t__storage_id = 6,
      P_FIELD_INDEX_mavlink_storage_information_t__status = 7,
      _P_FIELD_INDEX_mavlink_storage_information_t_COUNT = 8
    };

...
public:
    ...
    void SetTargetLocalVelocity(float x, float y, float z){ this->px4com->SetTargetLocalVelocity(x,y,z); };
    ...
    void GoToVelocity(float x, float y, float z, double eps);
    ...
    bool CloseToVelocity(float x, float y, float z, float eps);

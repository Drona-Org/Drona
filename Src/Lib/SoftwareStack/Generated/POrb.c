  ...
  static PRT_MAPTYPE P_GEND_TYPE_MAP_8 = 
  {
    &P_GEND_TYPE_Topics,
    &P_GEND_TYPE_7
  };
  ...
  static PRT_TYPE *P_GEND_TYPE_TUP_ARR_10[] = 
  {
    &P_GEND_TYPE_3,
    &P_GEND_TYPE_4
  };
  static PRT_TUPTYPE P_GEND_TYPE_TUP_10 = 
  {
    2,
  ...
  PRT_EVENTDECL P_EVENT_porb_local_STRUCT = 
  {
    P_EVENT_porb_local,
    "porb_local",
    4294967295U,
  ...
  PRT_VARDECL P_GEND_VARS_POrbMachine[] = 
  {
    ...
    {
        P_VAR_POrbMachine_topicSubscribers,
  ...
  PRT_TRANSDECL P_GEND_TRANS_POrbMachine_Init[] = 
  {
  ...
  {
    {
      ...
      p_tmp_ret = NULL;
      PrtPopFrame(p_tmp_mach_priv, &p_tmp_frame);
      P_STMT_0(PrtSetLocalVarEx(p_tmp_frame.locals, 3U, p_tmp_stmt_0, !PRT_FALSE), P_EXPR_0(&P_GEND_VALUE_22, PRT_FALSE), PRT_FALSE);
      while (P_BOOL_EXPR(P_EXPR_3(PrtMkBoolValue(PrtPrimGetInt(p_tmp_expr_0) < PrtPrimGetInt(p_tmp_expr_2)), PRT_TRUE, PrtMkIntValue(PrtSeqSizeOf(p_tmp_expr_1)), PRT_TRUE, p_tmp_frame.locals[0U], PRT_FALSE, p_tmp_frame.locals[3U], PRT_FALSE), PRT_TRUE))
      {
        ...
        P_STMT_0(PrtSetLocalVarEx(p_tmp_frame.locals, 3U, p_tmp_stmt_0, !PRT_TRUE), P_EXPR_2(PrtMkIntValue(PrtPrimGetInt(p_tmp_expr_0) + PrtPrimGetInt(p_tmp_expr_1)), PRT_TRUE, &P_GEND_VALUE_23, PRT_FALSE, p_tmp_frame.locals[3U], PRT_FALSE), PRT_FALSE);
      }
      goto P_EXIT_FUN;
      P_EXIT_FUN:
      PrtFreeLocals(p_tmp_mach_priv, &p_tmp_frame);
  ...
  {
    {
      ...
      p_tmp_ret = NULL;
      PrtPopFrame(p_tmp_mach_priv, &p_tmp_frame);
      P_STMT_0(PrtSetLocalVarEx(p_tmp_frame.locals, 2U, p_tmp_stmt_0, !PRT_FALSE), P_EXPR_0(&P_GEND_VALUE_22, PRT_FALSE), PRT_FALSE);
      while (P_BOOL_EXPR(P_EXPR_3(PrtMkBoolValue(PrtPrimGetInt(p_tmp_expr_0) < PrtPrimGetInt(p_tmp_expr_2)), PRT_TRUE, PrtMkIntValue(PrtSeqSizeOf(p_tmp_expr_1)), PRT_TRUE, p_tmp_frame.locals[1U], PRT_FALSE, p_tmp_frame.locals[2U], PRT_FALSE), PRT_TRUE))
      {
        ...
        P_STMT_0(PrtSetLocalVarEx(p_tmp_frame.locals, 2U, p_tmp_stmt_0, !PRT_TRUE), P_EXPR_2(PrtMkIntValue(PrtPrimGetInt(p_tmp_expr_0) + PrtPrimGetInt(p_tmp_expr_1)), PRT_TRUE, &P_GEND_VALUE_23, PRT_FALSE, p_tmp_frame.locals[2U], PRT_FALSE), PRT_FALSE);
      }
  ...
  {
    {
      ...
      P_STMT_0(PrtRaise(p_tmp_mach_priv, p_tmp_stmt_0, 0U), P_EXPR_0(&P_GEND_VALUE_14, PRT_FALSE), PRT_FALSE);
      goto P_EXIT_FUN;
      goto P_EXIT_FUN;
      P_EXIT_FUN:
      PrtFreeLocals(p_tmp_mach_priv, &p_tmp_frame);
  ...
  {
    {
      ...
      {
        P_STMT_1(PrtMapUpdateEx(p_tmp_mach_priv->varValues[P_VAR_POrbMachine_topicSubscribers], p_tmp_stmt_1, PRT_TRUE, p_tmp_stmt_0, !PRT_TRUE), P_EXPR_1(PrtTupleGetNC(p_tmp_expr_0, 0), PRT_FALSE, p_tmp_frame.locals[0U], PRT_FALSE), PRT_FALSE, P_EXPR_0(PrtMkDefaultValue(&P_GEND_TYPE_7), PRT_TRUE), PRT_FALSE);
        P_STMT_1(PrtSeqInsertEx(PrtMapGetNC(p_tmp_mach_priv->varValues[P_VAR_POrbMachine_topicSubscribers], p_tmp_stmt_1), PrtTupleGetNC(p_tmp_stmt_0, 0U), PrtTupleGetNC(p_tmp_stmt_0, 1U), PRT_FALSE), P_EXPR_1(PrtTupleGetNC(p_tmp_expr_0, 0), PRT_FALSE, p_tmp_frame.locals[0U], PRT_FALSE), PRT_FALSE, P_EXPR_3(P_TUPLE_1(&P_GEND_TYPE_10, p_tmp_expr_1, p_tmp_expr_2), PRT_TRUE, PrtTupleGetNC(p_tmp_expr_0, 1), PRT_FALSE, &P_GEND_VALUE_22, PRT_FALSE, p_tmp_frame.locals[0U], PRT_FALSE), PRT_FALSE);
        PrtFree(PrtTupleGetNC(p_tmp_stmt_0, 0U));
        PrtFree(p_tmp_stmt_0->valueUnion.tuple->values);
        PrtFree(p_tmp_stmt_0->valueUnion.tuple);
  ...
  PRT_FUNDECL P_GEND_FUNS_POrbMachine[] = 
  {
    ...
    {
        P_FUN_POrbMachine_InitializeListener,
        P_MACHINE_POrbMachine,
        "InitializeListener",
    ...
    {
        P_FUN_POrbMachine_IsSubscribed,
        P_MACHINE_POrbMachine,
        "IsSubscribed",
  ...
  PRT_STATEDECL P_GEND_STATES_POrbMachine[] = 
  {
    
    {
        ...
        0,
        P_GEND_EVENTSET,
        P_GEND_EVENTSET_porb_local,
        P_GEND_EVENTSET,
        P_GEND_TRANS_POrbMachine_Init,
        NULL,
        P_FUN_POrbMachine_ANON6,
        P_FUN_POrbMachine_ANON2,
        0U,
  ...
  PRT_MACHINEDECL P_MACHINE_POrbMachine_STRUCT = 
  {
    ...
    &P_CTOR_POrbMachine_IMPL,
    &P_DTOR_POrbMachine_IMPL,
    0U,
    NULL
  };

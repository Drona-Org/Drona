...
PRT_VALUE* P_decrease_battery_IMPL(PRT_MACHINEINST* context, PRT_VALUE*** argRefs);
extern PRT_FUNDECL P_FUNCTION_decrease_battery;
...
PRT_EVENTDECL* P_MotionPlanner_RECV_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_PlanExecutor_RECV_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_Robot_RECV_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_Battery_RECV_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_Project_RECV_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_MotionPlanner_RECV_INNER_1[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_MotionPlanner_SEND_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_PlanExecutor_RECV_INNER_1[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_PlanExecutor_SEND_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_VARDECL P_Robot_VARS[] = {
    ...
    { "safe_motion_plan", &P_GEND_TYPE_i }
};
...
PRT_EVENTDECL* P_WaitRequest_TRANS_INNER_2[] = { &P_EVENT_critical_battery };
...
{
    { 2, &P_EVENT_critical_battery, 3, &_P_NO_OP }
};
...
PRT_EVENTDECL* P_sendPlantoExecutorState_TRANS_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery };
...
PRT_TRANSDECL P_TRANS_8[] =
{
    ...
    { 1, &P_EVENT_critical_battery, 3, &_P_NO_OP }
};
...
PRT_EVENTDECL* P_safeControllerState_DEFERS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_safeControllerState_DEFERS =
{
    0U,
    P_safeControllerState_DEFERS_INNER,
    NULL
};

PRT_EVENTDECL* P_safeControllerState_TRANS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_safeControllerState_TRANS =
{
    0U,
    P_safeControllerState_TRANS_INNER,
    NULL
};

PRT_EVENTDECL* P_safeControllerState_DOS_INNER[] = { NULL };
PRT_EVENTSETDECL P_EVENTSET_safeControllerState_DOS =
{
    0U,
    P_safeControllerState_DOS_INNER,
    NULL
};

#define P_STATE_Robot_safeControllerState \
{ \
    "Robot.safeControllerState", \
    0U, \
    0U, \
    &P_EVENTSET_safeControllerState_DEFERS, \
    &P_EVENTSET_safeControllerState_TRANS, \
    &P_EVENTSET_safeControllerState_DOS, \
    NULL, \
    NULL, \
    &P_FUNCTION_Anon_9, \
    &_P_NO_OP, \
...
PRT_STATEDECL P_Robot_STATES[] = { P_STATE_Robot_Init, P_STATE_Robot_sendPlantoExecutorState, P_STATE_Robot_WaitRequest, P_STATE_Robot_safeControllerState };
...
PRT_VALUE* P_Anon_IMPL_6(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_21 = PrtCloneValue((p_this->id));
    
    PRT_VALUE** P_LVALUE_22 = &(PTMP_tmp5_1);
    PrtFreeValue(*P_LVALUE_22);
    *P_LVALUE_22 = PrtCloneValue(PrtMkInterface(context, 3, 1, &(PTMP_tmp4_1))->id);
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_6;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    
    {
        ...
        *P_LVALUE_23 = PTMP_tmp5_1;
        PTMP_tmp5_1 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_24 = &(p_this->varValues[5]);
    ...
    *P_LVALUE_26 = PrtCloneValue((&P_EVENT_requestMotionPlan.value));
    
    PRT_VALUE** P_LVALUE_27 = &(PTMP_tmp8);
    PrtFreeValue(*P_LVALUE_27);
    *P_LVALUE_27 = PrtCloneValue(*P_VAR_payload_4);
    ...
    switch (P_eventId) {
        case 2: {
            PRT_VALUE** P_VAR_tmp = &P_VAR_P_payload;
                        PRT_VALUE** P_LVALUE_28 = &(p_this->varValues[4]);
            PrtFreeValue(*P_LVALUE_28);
            *P_LVALUE_28 = PrtCloneValue(*P_VAR_tmp);
    ...
    *P_LVALUE_29 = PrtCloneValue((&P_EVENT_Success.value));
...
PRT_VALUE* P_Anon_IMPL_8(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE** P_LVALUE_30 = &(PTMP_tmp0_5);
    ...
    *P_LVALUE_31 = PrtCloneValue((&P_EVENT_executePlan.value));
    
    PRT_VALUE** P_LVALUE_32 = &(PTMP_tmp2_3);
    PrtFreeValue(*P_LVALUE_32);
    *P_LVALUE_32 = PrtCloneValue(p_this->varValues[4]);
...
PRT_VALUE* P_Anon_IMPL_9(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE P_LIT_DOUBLE = { PRT_VALUE_KIND_FLOAT, { .ft = 0.5 } };
    PRT_VALUE P_LIT_DOUBLE_1 = { PRT_VALUE_KIND_FLOAT, { .ft = 1 } };
    PRT_VALUE P_LIT_DOUBLE_2 = { PRT_VALUE_KIND_FLOAT, { .ft = 0 } };
    PRT_VALUE** P_LVALUE_33 = &(PTMP_tmp0_6);
    PrtFreeValue(*P_LVALUE_33);
    *P_LVALUE_33 = PrtMkDefaultValue(&P_GEND_TYPE_ST3fff);
    
    {
        PRT_VALUE** P_LVALUE_34 = &(P_VAR_s);
        PrtFreeValue(*P_LVALUE_34);
        *P_LVALUE_34 = PTMP_tmp0_6;
        PTMP_tmp0_6 = NULL;
    }
    ...
    *P_LVALUE_37 = PrtCloneValue((&P_LIT_DOUBLE_2));
    
    PRT_VALUE** P_LVALUE_38 = &(PTMP_tmp4_2);
    PrtFreeValue(*P_LVALUE_38);
    *P_LVALUE_38 = (PrtMkTuple(&P_GEND_TYPE_T3fff, &(PTMP_tmp1_4), &(PTMP_tmp2_4), &(PTMP_tmp3_2)));
    
    PrtSeqInsertEx(P_VAR_s, (&P_LIT_INT32), PTMP_tmp4_2, PRT_FALSE);
    *(&(PTMP_tmp4_2)) = NULL;
    ...
    *P_LVALUE_42 = (PrtMkTuple(&P_GEND_TYPE_T3fff, &(PTMP_tmp5_2), &(PTMP_tmp6_1), &(PTMP_tmp7_1)));
    ...
    *P_LVALUE_44 = PrtCloneValue((&P_EVENT_requestMotionPlan.value));
    
    PRT_VALUE** P_LVALUE_45 = &(PTMP_tmp11);
    PrtFreeValue(*P_LVALUE_45);
    *P_LVALUE_45 = PrtCloneValue(P_VAR_s);
    
    PrtSendInternal(context, PrtGetMachine(context->process, PTMP_tmp9_1), PTMP_tmp10, 1, &(PTMP_tmp11));
    *(&(PTMP_tmp10)) = NULL;
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
    ...
    switch (P_eventId_1) {
        case 2: {
            PRT_VALUE** P_VAR_tmp_1 = &P_VAR_P_payload_1;
                        PRT_VALUE** P_LVALUE_46 = &(p_this->varValues[6]);
            PrtFreeValue(*P_LVALUE_46);
            *P_LVALUE_46 = PrtCloneValue(*P_VAR_tmp_1);
    ...
    *P_LVALUE_48 = PrtCloneValue((&P_EVENT_executePlan.value));
    
    PRT_VALUE** P_LVALUE_49 = &(PTMP_tmp14);
    PrtFreeValue(*P_LVALUE_49);
    *P_LVALUE_49 = PrtCloneValue(p_this->varValues[6]);
    
    PrtSendInternal(context, PrtGetMachine(context->process, PTMP_tmp12), PTMP_tmp13, 1, &(PTMP_tmp14));
    *(&(PTMP_tmp13)) = NULL;
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_10;
    }
...
PRT_FUNDECL* P_Robot_METHODS[] = { &P_FUNCTION_Anon_6, &P_FUNCTION_Anon_7, &P_FUNCTION_Anon_8, &P_FUNCTION_Anon_9 };

PRT_EVENTDECL* P_Robot_RECV_INNER_1[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_Robot_SEND_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_UINT32 P_Robot_CREATES_ARR[] = { 3, 0, 1 };
PRT_INTERFACESETDECL P_Robot_CREATES = { 3, P_Robot_CREATES_ARR };
...
PRT_VARDECL P_Battery_VARS[] = {
    ...
    { "battery_percentage", &P_GEND_TYPE_f }
};
...
PRT_VALUE* P_Anon_IMPL_10(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    *P_LVALUE_51 = PrtCloneValue((&P_LIT_DOUBLE_3));
    
    PrtFreeValue(P_decrease_battery_IMPL(context, _P_GEN_funargs));
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_12;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    *P_LVALUE_52 = PrtCloneValue((&P_EVENT_Success.value));
    
    PrtRaise(p_this, PTMP_tmp0_7, 0);
    *(&(PTMP_tmp0_7)) = NULL;
    goto p_return_12;
...
PRT_VALUE* P_decrease_battery_IMPL(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE _P_GEN_null = { PRT_VALUE_KIND_NULL, { .ev = PRT_SPECIAL_EVENT_NULL } };
    PRT_VALUE P_LIT_DOUBLE_4 = { PRT_VALUE_KIND_FLOAT, { .ft = 0.5 } };
    PRT_VALUE P_LIT_DOUBLE_5 = { PRT_VALUE_KIND_FLOAT, { .ft = 0.1 } };
    PRT_VALUE** P_LVALUE_53 = &(PTMP_tmp0_8);
    PrtFreeValue(*P_LVALUE_53);
    *P_LVALUE_53 = PrtMkBoolValue(PrtPrimGetFloat(p_this->varValues[1]) > PrtPrimGetFloat((&P_LIT_DOUBLE_4)));
    
    PRT_VALUE** P_LVALUE_54 = &(PTMP_tmp1_5);
    PrtFreeValue(*P_LVALUE_54);
    *P_LVALUE_54 = PrtCloneValue(PTMP_tmp0_8);
    ...
    while (PrtPrimGetBool(PTMP_tmp1_5))
    {
        ...
        *P_LVALUE_55 = PrtMkFloatValue(PrtPrimGetFloat(p_this->varValues[1]) - PrtPrimGetFloat((&P_LIT_DOUBLE_5)));
        ...
        {
            PRT_VALUE** P_LVALUE_56 = &(p_this->varValues[1]);
            PrtFreeValue(*P_LVALUE_56);
            *P_LVALUE_56 = PTMP_tmp2_5;
            PTMP_tmp2_5 = NULL;
        }
        
        PRT_VALUE** P_LVALUE_57 = &(PTMP_tmp0_8);
        PrtFreeValue(*P_LVALUE_57);
        *P_LVALUE_57 = PrtMkBoolValue(PrtPrimGetFloat(p_this->varValues[1]) > PrtPrimGetFloat((&P_LIT_DOUBLE_4)));
        
        PRT_VALUE** P_LVALUE_58 = &(PTMP_tmp1_5);
        PrtFreeValue(*P_LVALUE_58);
        *P_LVALUE_58 = PrtCloneValue(PTMP_tmp0_8);
        
    }
    
    
    PRT_VALUE** P_LVALUE_59 = &(PTMP_tmp3_3);
    PrtFreeValue(*P_LVALUE_59);
    *P_LVALUE_59 = PrtCloneValue(p_this->varValues[0]);
    
    PRT_VALUE** P_LVALUE_60 = &(PTMP_tmp4_3);
    PrtFreeValue(*P_LVALUE_60);
    *P_LVALUE_60 = PrtCloneValue((&P_EVENT_critical_battery.value));
    
    PrtSendInternal(context, PrtGetMachine(context->process, PTMP_tmp3_3), PTMP_tmp4_3, 0);
    *(&(PTMP_tmp4_3)) = NULL;
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_14;
    }
...
PRT_FUNDECL P_FUNCTION_decrease_battery =
{
    "decrease_battery",
    &P_decrease_battery_IMPL,
    NULL
};


PRT_FUNDECL* P_Battery_METHODS[] = { &P_FUNCTION_Anon_10, &P_FUNCTION_Anon_11, &P_FUNCTION_decrease_battery };

PRT_EVENTDECL* P_Battery_RECV_INNER_1[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_Battery_SEND_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_WaitRequest_TRANS_INNER_4[] = { NULL };
...
PRT_VALUE* P_Anon_IMPL_12(PRT_MACHINEINST* context, PRT_VALUE*** argRefs)
{
    ...
    PRT_VALUE P_LIT_DOUBLE_7 = { PRT_VALUE_KIND_FLOAT, { .ft = 2 } };
    PRT_VALUE** P_LVALUE_61 = &(PTMP_tmp0_9);
    PrtFreeValue(*P_LVALUE_61);
    *P_LVALUE_61 = PrtMkDefaultValue(&P_GEND_TYPE_ST3fff);
    
    {
        PRT_VALUE** P_LVALUE_62 = &(p_this->varValues[1]);
        PrtFreeValue(*P_LVALUE_62);
        *P_LVALUE_62 = PTMP_tmp0_9;
        PTMP_tmp0_9 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_63 = &(PTMP_tmp1_6);
    PrtFreeValue(*P_LVALUE_63);
    *P_LVALUE_63 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_64 = &(PTMP_tmp2_6);
    PrtFreeValue(*P_LVALUE_64);
    *P_LVALUE_64 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_65 = &(PTMP_tmp3_4);
    PrtFreeValue(*P_LVALUE_65);
    *P_LVALUE_65 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_66 = &(PTMP_tmp4_4);
    PrtFreeValue(*P_LVALUE_66);
    *P_LVALUE_66 = (PrtMkTuple(&P_GEND_TYPE_T3fff, &(PTMP_tmp1_6), &(PTMP_tmp2_6), &(PTMP_tmp3_4)));
    
    PrtSeqInsertEx(p_this->varValues[1], (&P_LIT_INT32_2), PTMP_tmp4_4, PRT_FALSE);
    *(&(PTMP_tmp4_4)) = NULL;
    
    PRT_VALUE** P_LVALUE_67 = &(PTMP_tmp5_3);
    PrtFreeValue(*P_LVALUE_67);
    *P_LVALUE_67 = PrtCloneValue((&P_LIT_DOUBLE_7));
    
    PRT_VALUE** P_LVALUE_68 = &(PTMP_tmp6_2);
    PrtFreeValue(*P_LVALUE_68);
    *P_LVALUE_68 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_69 = &(PTMP_tmp7_2);
    PrtFreeValue(*P_LVALUE_69);
    *P_LVALUE_69 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_70 = &(PTMP_tmp8_2);
    PrtFreeValue(*P_LVALUE_70);
    *P_LVALUE_70 = (PrtMkTuple(&P_GEND_TYPE_T3fff, &(PTMP_tmp5_3), &(PTMP_tmp6_2), &(PTMP_tmp7_2)));
    
    PrtSeqInsertEx(p_this->varValues[1], (&P_LIT_INT32_3), PTMP_tmp8_2, PRT_FALSE);
    *(&(PTMP_tmp8_2)) = NULL;
    
    PRT_VALUE** P_LVALUE_71 = &(PTMP_tmp9_2);
    PrtFreeValue(*P_LVALUE_71);
    *P_LVALUE_71 = PrtCloneValue((&P_LIT_DOUBLE_7));
    
    PRT_VALUE** P_LVALUE_72 = &(PTMP_tmp10_1);
    PrtFreeValue(*P_LVALUE_72);
    *P_LVALUE_72 = PrtCloneValue((&P_LIT_DOUBLE_7));
    
    PRT_VALUE** P_LVALUE_73 = &(PTMP_tmp11_1);
    PrtFreeValue(*P_LVALUE_73);
    *P_LVALUE_73 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_74 = &(PTMP_tmp12_1);
    PrtFreeValue(*P_LVALUE_74);
    *P_LVALUE_74 = (PrtMkTuple(&P_GEND_TYPE_T3fff, &(PTMP_tmp9_2), &(PTMP_tmp10_1), &(PTMP_tmp11_1)));
    
    PrtSeqInsertEx(p_this->varValues[1], (&P_LIT_INT32_4), PTMP_tmp12_1, PRT_FALSE);
    *(&(PTMP_tmp12_1)) = NULL;
    
    PRT_VALUE** P_LVALUE_75 = &(PTMP_tmp13_1);
    PrtFreeValue(*P_LVALUE_75);
    *P_LVALUE_75 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_76 = &(PTMP_tmp14_1);
    PrtFreeValue(*P_LVALUE_76);
    *P_LVALUE_76 = PrtCloneValue((&P_LIT_DOUBLE_7));
    
    PRT_VALUE** P_LVALUE_77 = &(PTMP_tmp15);
    PrtFreeValue(*P_LVALUE_77);
    *P_LVALUE_77 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_78 = &(PTMP_tmp16);
    PrtFreeValue(*P_LVALUE_78);
    *P_LVALUE_78 = (PrtMkTuple(&P_GEND_TYPE_T3fff, &(PTMP_tmp13_1), &(PTMP_tmp14_1), &(PTMP_tmp15)));
    
    PrtSeqInsertEx(p_this->varValues[1], (&P_LIT_INT32_5), PTMP_tmp16, PRT_FALSE);
    *(&(PTMP_tmp16)) = NULL;
    
    PRT_VALUE** P_LVALUE_79 = &(PTMP_tmp17);
    PrtFreeValue(*P_LVALUE_79);
    *P_LVALUE_79 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_80 = &(PTMP_tmp18);
    PrtFreeValue(*P_LVALUE_80);
    *P_LVALUE_80 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_81 = &(PTMP_tmp19);
    PrtFreeValue(*P_LVALUE_81);
    *P_LVALUE_81 = PrtCloneValue((&P_LIT_DOUBLE_6));
    
    PRT_VALUE** P_LVALUE_82 = &(PTMP_tmp20);
    PrtFreeValue(*P_LVALUE_82);
    *P_LVALUE_82 = (PrtMkTuple(&P_GEND_TYPE_T3fff, &(PTMP_tmp17), &(PTMP_tmp18), &(PTMP_tmp19)));
    
    PrtSeqInsertEx(p_this->varValues[1], (&P_LIT_INT32_6), PTMP_tmp20, PRT_FALSE);
    *(&(PTMP_tmp20)) = NULL;
    
    PRT_VALUE** P_LVALUE_83 = &(PTMP_tmp21);
    PrtFreeValue(*P_LVALUE_83);
    *P_LVALUE_83 = PrtCloneValue(p_this->varValues[1]);
    
    PRT_VALUE** P_LVALUE_84 = &(PTMP_tmp22);
    PrtFreeValue(*P_LVALUE_84);
    *P_LVALUE_84 = PrtCloneValue(PrtMkInterface(context, 2, 1, &(PTMP_tmp21))->id);
    if (p_this->returnKind != ReturnStatement && p_this->returnKind != ReceiveStatement) {
        goto p_return_15;
    }
    if (p_this->isHalted == PRT_TRUE) {
    ...
    
    {
        ...
        *P_LVALUE_85 = PTMP_tmp22;
        PTMP_tmp22 = NULL;
    }
    
    PRT_VALUE** P_LVALUE_86 = &(PTMP_tmp23);
    PrtFreeValue(*P_LVALUE_86);
    *P_LVALUE_86 = PrtCloneValue((&P_EVENT_Success.value));
...
PRT_FUNDECL* P_Project_METHODS[] = { &P_FUNCTION_Anon_12, &P_FUNCTION_Anon_13 };

PRT_EVENTDECL* P_Project_RECV_INNER_1[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_Project_SEND_INNER[] = { &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_requestMotionPlan };
...
PRT_EVENTDECL* P_ALL_EVENTS[] = { &_P_EVENT_NULL_STRUCT, &_P_EVENT_HALT_STRUCT, &P_EVENT_receiveMotionPlan, &P_EVENT_Success, &P_EVENT_critical_battery, &P_EVENT_executePlan, &P_EVENT_requestMotionPlan };
PRT_MACHINEDECL* P_ALL_MACHINES[] = { &P_MACHINE_MotionPlanner, &P_MACHINE_PlanExecutor, &P_MACHINE_Robot, &P_MACHINE_Battery, &P_MACHINE_Project };
PRT_INTERFACEDECL* P_ALL_INTERFACES[] = { &P_I_MotionPlanner, &P_I_PlanExecutor, &P_I_Robot, &P_I_Battery, &P_I_Project };
PRT_FUNDECL* P_ALL_FUNCTIONS[] = { NULL };
PRT_FOREIGNTYPEDECL* P_ALL_FOREIGN_TYPES[] = { NULL };
int P_DefaultImpl_LME_0[] = { -1,-1,-1,-1,-1 };
int P_DefaultImpl_LME_1[] = { -1,-1,-1,-1,-1 };
int P_DefaultImpl_LME_2[] = { 0,1,-1,3,-1 };
int P_DefaultImpl_LME_3[] = { -1,-1,-1,-1,-1 };
int P_DefaultImpl_LME_4[] = { -1,-1,2,-1,-1 };
